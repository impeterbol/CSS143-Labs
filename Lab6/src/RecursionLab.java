...
//		int solution = iterativeSum( 20 );
		...
		fact = factorial(num);
		System.out.println("result : number is "+num+" and factorial is "+fact );
		//Some GUI details
...
//note to self - good explanation
	//https://www.dreamincode.net/forums/topic/323865-combinatorial-choose-function-and-recursion/
