...
//        a.setDenom(5);
    ...
    public static void mutate(int z) {  //does it matter that I called my input data "z" here? NO
        z = -1000;  //if z is only a copy, this won't affect the variable a's value in main
        
        //this.foo = -1000;
        //why does the line above cause compiler errors? foo is not defined
    }
    ...
    public static void mutate(Dimension c) {  
        ...
        //SHOULD BE THE SAME AS C HERE IS JUST A VAR NAME OF AN OBJECT THAT IS PASSED
        ...
        //YES BECAUSE YOU ADJUTED THE OBJECT
    }
